use crate::models::{BoardNoteCreate, BoardNotePatch, Chat, WordDefinition, BoardNote};
...
#[command]
#[specta::specta]
pub async fn get_top_n(query: String, samples: u32) -> Result<Vec<(f64, String, WordDefinition)>, String> {
